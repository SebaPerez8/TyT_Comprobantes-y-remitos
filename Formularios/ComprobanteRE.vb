...
Retiro / Entrega"
    ...
    Private Sub PrintDocument_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PrintDocument.PrintPage
        ...
        'Cabecera
        Dim newWidth As Integer = 250   ' Ancho deseado para la imagen
        Dim newHeight As Integer = 170  ' Altura deseada para la imagen
        e.Graphics.DrawImage(PictureBox.Image, X - 50, Y - 80, newWidth, newHeight)
        ...
        'Cabecera
        e.Graphics.DrawImage(PictureBox.Image, X - 50, Y + 470, newWidth, newHeight)
